...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { comment: @instructor.comment, email: @instructor.email, first: @instructor.first, last: @instructor.last, middle: @instructor.middle }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { comment: @instructor.comment, email: @instructor.email, first: @instructor.first, last: @instructor.last, middle: @instructor.middle }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
